...
```
npm create cloudflare@latest -- --template=cloudflare/templates/autumn-mud-3d68
```

## Preview Deployment

A live public deployment of this template is available at [https://autumn-mud-3d68.templates.workers.dev](https://autumn-mud-3d68.templates.workers.dev)
